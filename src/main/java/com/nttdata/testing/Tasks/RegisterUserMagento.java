...
public class RegisterUserMagento implements Task {

    private final String username;
    private final String password;

    public RegisterUserMagento(String username, String password) {
    ...
    public static Performable withData(String username, String password) {
        return new RegisterUserMagento(username, password);
    }
}
